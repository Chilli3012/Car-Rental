...
<!-- main code  -->
    ...
    <form action="./userregistration.php" class="myform" method="post">
        <div class="frm-content">
            <div class="row form flex-column align-items-center justify-content-center">
                ...
                <div class="col-12 col-md-8 col-lg-6 d-flex flex-column justify-content-around">
                    <h2 class="text-center login-title">User Registration</h2>
                    <?php 
                    if($existornot)
                    {
                    ...
                    elseif($suc)
                    {
                        ...
                        Registered Successfully!! You can login now.</a>
                      </div>';
                    }
                    elseif($showerror)
                    {
