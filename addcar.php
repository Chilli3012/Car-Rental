...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
    ...
    if($rowcount>0) 
        ...
        $sql2 = "INSERT INTO `car` (`id`, `model`, `num`, `capacity`, `rent`, `available`, `booked`, `duration`, `startdate`) VALUES (NULL, '$model', '$num', '$capacity', '$rent', current_timestamp(), '0', '1', current_timestamp())";
...
<!-- main code  -->
    ...
    <form action="./addcar.php" class="myform" method="post">
