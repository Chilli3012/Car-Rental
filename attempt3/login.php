...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
    ...
    $sql="Select id, name,emid from user where email='$email' AND password='$password' ";
        ...
        <div class="frm-content">
            <div class="row form flex-column align-items-center justify-content-center">
                ...
                <div class="col-12 col-md-8 col-lg-6 d-flex flex-column justify-content-around">
                    ...
                    <div class="alert alert-success" role="alert" <?php if(!isset($login) || $login==false) echo 'style="display:none"'?>>
                ...
                <div class="col-12 col-md-8 col-lg-6 d-flex flex-column justify-content-around">
                    <span><a href="register.php">or register  as a new user?</a></span><br>
                </div>
