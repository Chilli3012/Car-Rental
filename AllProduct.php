...
if(isset($_POST["submit"])) {
    ...
    $sql4="INSERT INTO rentals (user_id,car_id,rental_start_date) VALUES('$user_id','$id','$startdate')";
   ...
   <div >
        <div class="header-part1">
            ...
            <a href="index.php" class="navbar-brand brand-logo">
                <img class="brand-logo" src="Images/logo7.jpeg" alt="logo">
            </a>
                        ...
                        if($booked==false)
                        {
                            ...
                            <form method="post" action="'.$page.'">
                                <div class="card overflow-hidden"> 
                                    <img class="card-img-top image-styling" src="Images/car5.jpg" alt="Car">
                                    <div class="card-body">
                                        ...
                                        {
                                           echo '<button type="submit" name="submit" class="btn btn-primary" disabled>Rent</button>';
                                        }
                                        elseif(!$loggedin){
                                            echo '<a href="login.php"><button type="button" name="submit" class="btn btn-primary">Rent</button></a>';
                                        }
                                        else{
                                            echo '<button type="submit" name="submit" class="btn btn-primary">Rent</button>';
                                        }
